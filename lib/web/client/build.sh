...
wasm-bindgen --target web --out-dir out/ target/wasm32-unknown-unknown/release/nubila_client.wasm
...
mv out/nubila_client_bg.wasm out/nubila_client_unoptimized.wasm
wasm-opt $WASMOPTFLAGS --signext-lowering out/nubila_client_unoptimized.wasm -o out/nubila_client_lowered.wasm
...
if [ "${RELEASE:-0}" = "1" ]; then
	(
		...
		time wasm-opt $WASMOPTFLAGS \
			out/nubila_client_lowered.wasm -o out/nubila_client_bg.wasm \
			--converge \
	...
	mv out/nubila_client_lowered.wasm out/nubila_client_bg.wasm
fi
...
AUTOGENERATED_SOURCE=$(<"out/nubila_client.js")

AUTOGENERATED_SNIPPET_PATH=$(<"out/nubila_client.js")
...
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//'nubila_client.wasm'/'nubila.wasm'}
...
echo "$AUTOGENERATED_SOURCE" > pkg/nubila.js
echo "$AUTOGENERATED_INFO_FUNC" >> pkg/nubila.js

WASM_BASE64=$(base64 -w0 out/nubila_client_bg.wasm)
...
echo "$AUTOGENERATED_SOURCE" > pkg/nubila-bundled.js
echo "$AUTOGENERATED_INFO_FUNC" >> pkg/nubila-bundled.js

# === types ===

AUTOGENERATED_TYPES=$(<"out/nubila_client.d.ts")
...
echo "$AUTOGENERATED_TYPES" > pkg/nubila.d.ts
echo "$AUTOGENERATED_INFO_FUNC_TYPE" >> pkg/nubila.d.ts
...
echo "$AUTOGENERATED_TYPES" > pkg/nubila-bundled.d.ts
echo "$AUTOGENERATED_INFO_FUNC_TYPE" >> pkg/nubila-bundled.d.ts

cp out/nubila_client_bg.wasm pkg/nubila.wasm
